...
<div class="modal-header">
    ...
    <h4 class="modal-title">Relat&oacute;rio das receitas do m&ecirc;s de <?php echo mes_extenso($_GET[''.$getmes.'']); ?></h4>
</div>
    ...
    try {
        ...
        $ret = $sql->rowCount();
            ...
            if($ret > 0) {
                ...
                echo'
                <table class="table table-striped table-bordered table-hover table-data-report-receita dt-responsive nowrap" style="width: 100%;">
                    <thead>
                        <tr>
                            <th>Dia</th>
                            <th>Tipo</th>
                ...
                echo'
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th>Descri&ccedil;&atilde;o</th>
                            <th>Categoria</th>
                            <th class="lead text-success text-right">R$ '.number_format($total, 2, '.', ',').'</th>
                        </tr>
                    </tfoot>
                </table>';
...
<script>
    (function ($) {
        ...
        $(".table-data-report-receita").show(function () {
            $(".table-data-report-receita").DataTable({
                "paging": false,
                //"ordering": false,
                "info": false,
                "filter": false,
